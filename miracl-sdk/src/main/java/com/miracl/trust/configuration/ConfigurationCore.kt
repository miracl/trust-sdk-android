 ...
 */
public class ConfigurationCore private constructor(
    ...
    internal constructor(configuration: Configuration) :
            this(
                ...
                configuration.componentFactory,
                configuration.userStorage,
                configuration.logger,
                configuration.loggingLevel,
                configuration.miraclCoroutineContext,
    ...
    /** Builds a [ConfigurationCore] object. */
    public class Builder constructor() {
        ...
        /** Returns a [com.miracl.trust.configuration.ConfigurationCore] object. */
        public fun build(): ConfigurationCore {
