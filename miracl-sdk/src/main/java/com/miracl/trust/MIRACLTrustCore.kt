...
import com.miracl.trust.project.ProjectApiManager
...
public class MIRACLTrustCore private constructor(
    ...
    private val projectApi: ProjectApiManager
    ...
    init {
        ...
        projectApi = ProjectApiManager(apiRequestExecutor, KotlinxSerializationJsonUtil)
    }
    //endregion
    ...
    public fun sendVerificationEmail(
        ...
        miraclTrustScope.launch {
            verificator.sendVerificationEmail(
                userId = userId,
                projectId = authenticationSessionDetails.projectId,
                projectUrl = authenticationSessionDetails.projectUrl,
                deviceName = deviceName,
                authenticationSessionDetails = authenticationSessionDetails
            ).also { result ->
                if (result is MIRACLError) {
    ...
    public fun sendVerificationEmail(
        ...
        miraclTrustScope.launch {
            verificator.sendVerificationEmail(
                userId = userId,
                projectId = crossDeviceSession.projectId,
    ...
    public fun generateQuickCode(
        ...
        miraclTrustScope.launch {
            val projectUrl = projectApi.getProjectUrl(user.projectId)!!
