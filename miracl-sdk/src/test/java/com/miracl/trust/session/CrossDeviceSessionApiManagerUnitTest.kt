...
class CrossDeviceSessionApiManagerUnitTest {
    ...
    @Test
    fun `executeUpdateSigningSessionRequest should return MIRACLSuccess when passed data is valid`() =
        runTest {
            // Arrange
            val sessionId = randomUuidString()
            ...
            // Act
            val result = apiManager.executeUpdateSigningSessionRequest(sessionId, signature)
    ...
    fun `executeUpdateSessionRequest returns MIRACLError when networkRequest returns an error`() =
        runTest {
            ...
            // Act
            val result = apiManager.executeUpdateSigningSessionRequest(
