...
class CrossDeviceSessionManagerUnitTest {
    ...
    fun `getCrossDeviceSessionFromAppLink should return MIRACLSuccess`() =
        runTest {
            ...
            Assert.assertEquals(crossDeviceSessionResponse.description, result.value.description)
            ...
            Assert.assertEquals(crossDeviceSessionResponse.hash, result.value.hash)
        }
