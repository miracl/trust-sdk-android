...
class DocumentSignerUnitTest {
    ...
    fun `sign with CrossDeviceSession should return MIRACLSuccess on success`() =
        runTest {
            ...
            val message = crossDeviceSession.hash.toByteArray()
            ...
            coEvery {
                crossDeviceSessionApiMock.executeUpdateSigningSessionRequest(any(), any())
            ...
            coVerify {
                crossDeviceSessionApiMock.executeUpdateSigningSessionRequest(
    ...
    fun `sign with CrossDeviceSession should return MIRACLError when updateSigningSessionRequest fails`() =
        runTest {
            ...
            coEvery {
                cryptoMock.sign(
                    crossDeviceSession.hash.toByteArray(),
                    mpinId.plus(publicKey),
                    token,
                    any(),
                    any()
